_qr_create() {
	...
	local link="https://fighting86.github.io/tools/qr.html#${vmess}"
	echo
	echo "---------- V2Ray 二维码 -------------"
	echo
	...
	echo
	echo
	echo " V2Ray 客户端使用教程: https://868v2.com/post/4/"
	echo
	echo
	rm -rf /etc/v2ray/vmess_qr.json
}
_ss_qr() {
	local ss_link="ss://$(echo -n "${ssciphers}:${sspass}@${ip}:${ssport}" | base64 -w 0)#868v2.com_ss_${ip}"
	local link="https://fighting86.github.io/tools/qr.html#${ss_link}"
	echo
